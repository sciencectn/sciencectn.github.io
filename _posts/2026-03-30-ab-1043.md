...
* Consult with developers or organizations involved in open source. System76 is the best starting point, given their activism on Colorado's related bill SB26-051. EFF, Canonical, the Linux Foundation, Red Hat, Mozilla Foundation, are also good starting points. There are thousands of developers across California who'd be eager to help, myself included.
* Narrow the scope of AB 1043 to exclude open source, as Colorado lawmakers are considering for SB26-051. The real targets of this bill are commercial app developers and device makers who profit off children. Since for-profit OS providers and developers don't give away their source code for free, the bill's intent is still intact. 
